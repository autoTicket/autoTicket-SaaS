...
?>
    <div id="main">
            <h1 style="color:#FF7700;"><?php echo __('autoTicket is already installed?');?></h1>
            <div id="intro">
             <p><?php echo sprintf(__('Configuration file already changed - which could mean autoTicket is already installed or the config file is corrupted. If you are trying to upgrade osTicket, then go to %s Admin Panel %s.'), '<a href="../scp/admin.php" >', '</a>');?></p>
