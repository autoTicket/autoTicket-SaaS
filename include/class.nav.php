...
class StaffNav
{
    ...
    { //Private.
        ...
        foreach ($this->getTabs() as $k => $tab) {
            ...
            switch (strtolower($k)) {
                case 'tickets':
                    $subnav[] = array('desc'=>__('Open'),
                        'title'=> __('View Open Tickets'),
                        'href'=>'tickets.php?queue=1',
                        'iconclass'=>'Ticket',
                        'id' => 'new-ticket');
                    $subnav[] = array('desc'=>__('My Tickets'),
                        'title'=> __('View Your Tickets'),
                        'href'=>'tickets.php?queue=5',
                        'iconclass'=>'assignedTickets',
                        'id' => 'new-ticket');
                    $subnav[] = array('desc'=>__('Closed'),
                        'title'=> __('View Closed Tickets'),
                        'href'=>'tickets.php?queue=8',
        ...
        foreach ($this->getTabs() as $k => $tab) {
            ...
            switch (strtolower($k)) {
                ...
                case 'manage':
                    ...
                    $subnav[] = array('desc'=>__('Subscription Mgnt.'),'href'=>'..\scp\ost_sub.php','title'=>'Sub','iconclass'=>'pages');
                    break;
                case 'emails':
